...
export default function App() {
  ...
  return <main><header><div className="brand-mark" aria-hidden="true">r3<span>p</span>o</div><h1>r3po</h1></header><p className="tagline">Scan public GitHub and GitLab repositories for CVEs, secrets, and SAST findings.</p>
